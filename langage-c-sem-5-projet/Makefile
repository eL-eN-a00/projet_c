...
OBJECTS= \
	point.o viewport.o grille_view.o window.o app.o liste_noeud.o grille.o coord.o grille_file.o \
	animation.o dijkstra.o creer_grille.o \
	main.o
...
help:
	...
	@echo "  test_coord              Compile les tests unitaires du module coord"
	@echo "  test_grille             Compile les tests unitaires du module grille"
	...
	@echo "  runtest_coord           Lance les tests unitaires du module liste_noeud"
	@echo "  runtest_grille          Lance les tests unitaires du module liste_noeud"
...
tests: test_struct test_coord test_grille test_liste_noeud test_dijkstra

test_struct: liste_noeud.o dijkstra.o
	./test_struct

runtest_coord: test_coord
	@echo "================= [   Test de coord   ] ================="
	./test_coord
